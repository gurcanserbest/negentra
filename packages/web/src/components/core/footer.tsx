  ...
  return (
    ...
    >
      <Container maxW='1410px'>
        <Grid templateColumns='585px auto' className='flex xl:grid'>
          <Flex w='100%' className='hidden xl:block'>
            <Image src='/images/bitmap.png' h='100%' loading='lazy' />
          </Flex>
          ...
          >
            ...
            <Flex direction='column'>
              <Flex marginBottom='12px'>
                <Text color='white' fontFamily='Titan One'>
                  Follow Us
                </Text>
              </Flex>
              ...
              <Flex className='space-x-[10px]'>
                {socialLinks.map((social, i) => (
                  ...
                  >
                    ...
                    >
                      <Image src={`/svg/${social.icon}.svg`} loading='lazy' />
                    </Flex>
                  </Link>
                ))}
              </Flex>
